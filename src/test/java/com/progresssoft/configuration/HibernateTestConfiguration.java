...
@ComponentScan({ "com.progresssoft.dao" })
public class HibernateTestConfiguration {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan(new String[] { "com.progresssoft.model" });
	...
	public DataSource dataSource() {
		...
		dataSource.setUrl("jdbc:mysql://localhost:3306/progresssoft_db;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE");
